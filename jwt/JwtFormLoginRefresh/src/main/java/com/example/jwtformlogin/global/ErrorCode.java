...
public enum ErrorCode {
    ...
    ACCESS_TOKEN_EXPIRED(HttpStatus.BAD_REQUEST, "Access token이 만료되었습니다.", "C001"),
    REFRESH_TOKEN_EXPIRED(HttpStatus.BAD_REQUEST, "Refresh token이 만료되었습니다.", "C002"),
    WRONG_CATEGORY_JWT(HttpStatus.BAD_REQUEST, "Wrong Category JWT", "C003"),
    NOT_EXIST_REFRESH_TOKEN(HttpStatus.BAD_REQUEST, "존재하지 않는 Refresh Token입니다.", "C004"),
    NO_REFRESH_TOKEN_COOKIE(HttpStatus.BAD_REQUEST, "Refresh Token Cookie가 존재하지 않습니다.", "C005");
